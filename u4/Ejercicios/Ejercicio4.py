def contarLetras(texto):
    letras = len(texto)
    print("Total letras letras %i" % letras)

elemento = str(input("Introduce texto para contar sus caracteres: "))
contarLetras(elemento)
'''
    Hace mucho tiempo el entusiasta de Python Tim Peters plasmó de forma
    concisa los principios de diseño por los que guiarse al escribir en
    Python según el BDFL (NT: Benevolent Dictator for Life o Dictador
    Benévolo de por Vida, en este caso Guido van Rossum, el creador de
    Python) en 20 aforismos, de los cuales sólo 19 han pasado a forma escrita.
